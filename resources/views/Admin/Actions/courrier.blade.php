...
@section('content')
  <div class="container p-2">
    <h3><i class="large material-icons text-indigo" style="font-size: 3rem;">email</i> Courriers à imprimer</h3>
    <hr>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12">
                ...
                <div class="section rounded-top" style="display: flex; justify-content: space-between; flex-direction: column">
                    ...
                    <div id="printable-section" style="border: #c0c0c0 0.5px solid" class="p-2 m-1 pt-2 pt-3 rounded">
                        <textarea name="body" id="modele-body" class="form-control" cols="3" rows="4"></textarea>
                    </div>
