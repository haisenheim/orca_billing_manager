...
@section('content')
  <div class="container p-2">
    <h3><i class="large material-icons text-warning" style="font-size: 3rem;">send</i> Sms à envoyer</h3>
    <hr>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <div style="display: flex; justify-content: space-between; flex-direction: column">
                    ...
                    <div>
                        <a href="/admin/actions/sms/batch" class="btn btn-sm btn-black">Envoyer en masse</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-12">
            ...
            <div class="col-md-4 col-sm-12">
                <form action="/admin/actions/relances/sms" method="post">
                    @csrf
                ...
                <div class="section rounded-top" style="display: flex; justify-content: space-between; flex-direction: column">
                    ...
                    <div style="border: #c0c0c0 0.5px solid" class="p-2 m-1 pt-2 pt-3 rounded">
                        <textarea name="body" id="modele-body" class="form-control summernote_" cols="3" rows="4"></textarea>
                    </div>
                    <div>
...
$('#modele-body').summernote({
    ...
    $('.click').click(function(){
        ...
        $.ajax({
            url:'/api/v1/relances/'+echeance_id+'/1/'+echeance_id,
            type:'get',
            dataType:'json',
