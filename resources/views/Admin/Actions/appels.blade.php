...
@section('content')
  <div class="container p-2">
    <h3><i class="large material-icons text-danger" style="font-size: 3rem;">phone</i> Appels à passer</h3>
    <hr>
    <div id="actions" class="container pl-5 pr-5 ml-3">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12">
                <form action="/admin/actions/relances/appel" method="post">
                    @csrf
                ...
                <div class="section rounded-top" style="display: flex; justify-content: space-between; flex-direction: column">
                    ...
                    <div>
                        <button type="submit" class="btn btn-sm btn-black">Enregistrer</button>
                    </div>
                </div>
                </form>
            </div>
